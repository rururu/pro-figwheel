window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=21091d&fwbuild=dev"};
...
document.write('<script>goog.require("hello.world");</script>');
