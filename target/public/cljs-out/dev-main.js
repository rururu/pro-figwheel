window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=16fcf7&fwbuild=dev"};
...
document.write('<script>goog.require("hello.reagent");</script>');
