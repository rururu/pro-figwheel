window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=579ef8&fwbuild=dev"};
...
document.write('<script>goog.require("hello.arttuka");</script>');
