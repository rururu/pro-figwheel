window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=4b7044&fwbuild=dev"};
...
document.write('<script>goog.require("hello.frontend");</script>');
