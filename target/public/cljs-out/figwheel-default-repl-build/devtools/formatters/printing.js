...
var len__4736__auto___10081 = arguments.length;
var i__4737__auto___10082 = (0);
while(true){
if((i__4737__auto___10082 < len__4736__auto___10081)){
args__4742__auto__.push((arguments[i__4737__auto___10082]));

var G__10083 = (i__4737__auto___10082 + (1));
i__4737__auto___10082 = G__10083;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq10078){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10079,G__10080,seq10078__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__10084_SHARP_){
return (!((cljs.core.meta.call(null,p1__10084_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__10085__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e10089){var _e__9063__auto__ = e10089;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e10091){var _e__9063__auto__ = e10091;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__10093 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__10094 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__10094);

try{var map__10095 = opts;
...
var markup_db = cljs.core.get.call(null,map__10095__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__10093);
}});
...
var temp__5802__auto___10100 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5802__auto___10100)){
var managed_print_level_10101 = temp__5802__auto___10100;
var _STAR_print_level_STAR__orig_val__10098_10102 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__10099_10103 = managed_print_level_10101;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__10099_10103);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__10097_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__10097_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__10098_10102);
}} else {
job_fn.call(null);
}
