...
var G__10052 = devtools.prefs.pref.call(null,v);
v = G__10052;
continue;
} else {
return v;
...
}catch (e10055){var _e__9063__auto__ = e10055;
return false;
}})();
...
}catch (e10059){var _e__9063__auto__ = e10059;
return false;
}})();
...
}catch (e10061){var _e__9063__auto__ = e10061;
return false;
}}
}
});
...
var vec__10063 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__10063,(0),null);
var name = cljs.core.nth.call(null,vec__10063,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10066_SHARP_);
}),template);
});
