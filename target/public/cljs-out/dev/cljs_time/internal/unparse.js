...
var periods__$1 = cljs.core.vec.call(null,(function (){var G__23877 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.call(null,(function (p1__23876_SHARP_){
return cljs.core.subs.call(null,p1__23876_SHARP_,(0),(3));
}),G__23877);
} else {
return G__23877;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__23886){
var vec__23887 = p__23886;
var t = cljs.core.nth.call(null,vec__23887,(0),null);
var pattern = cljs.core.nth.call(null,vec__23887,(1),null);
if(cljs.core._EQ_.call(null,t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__23890 = pattern;
switch (G__23890) {
case "S":
...
return p1__23892_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__23893_SHARP_){
return p1__23893_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__23894_SHARP_){
return p1__23894_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__23895_SHARP_){
return p1__23895_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__23896_SHARP_){
return p1__23896_SHARP_.getHours();
});

break;
case "day":
return (function (p1__23897_SHARP_){
return p1__23897_SHARP_.getDate();
});

break;
case "month":
return (function (p1__23898_SHARP_){
return p1__23898_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__23899_SHARP_){
return p1__23899_SHARP_.getYear();
});
...
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__23902){
...
break;
case "ordinal-suffix":
var vec__23907 = syntax_list.call(null,(i - (1)));
var k = cljs.core.nth.call(null,vec__23907,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__23906__$1)].join('')));
...
var d = value;
var G__23914 = cljs.core.map_indexed.call(null,cljs.core.partial.call(null,cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__23915 = G__23914;
...
var unparser = first__23917;
var more = seq__23916__$1;
var s = "";
var d__$1 = d;
...
while(true){
var d__$2 = d__$1;
var vec__23924 = G__23914__$1;
var seq__23925 = cljs.core.seq.call(null,vec__23924);
var first__23926 = cljs.core.first.call(null,seq__23925);
var seq__23925__$1 = cljs.core.next.call(null,seq__23925);
var unparser__$1 = first__23926;
var more__$1 = seq__23925__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__23927 = unparser__$1.call(null,s__$2,d__$2);
var s__$3 = cljs.core.nth.call(null,vec__23927,(0),null);
var d__$3 = cljs.core.nth.call(null,vec__23927,(1),null);
var G__23930 = d__$3;
var G__23931 = more__$1;
var G__23932 = s__$3;
d__$1 = G__23930;
G__23914__$1 = G__23931;
s__$1 = G__23932;
continue;
}
break;
