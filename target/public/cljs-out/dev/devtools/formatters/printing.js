...
var len__4736__auto___10530 = arguments.length;
var i__4737__auto___10531 = (0);
while(true){
if((i__4737__auto___10531 < len__4736__auto___10530)){
args__4742__auto__.push((arguments[i__4737__auto___10531]));

var G__10532 = (i__4737__auto___10531 + (1));
i__4737__auto___10531 = G__10532;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq10527){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10528,G__10529,seq10527__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__10533_SHARP_){
return (!((cljs.core.meta.call(null,p1__10533_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__10534__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e10538){var _e__9280__auto__ = e10538;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e10540){var _e__9280__auto__ = e10540;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__10542 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__10543 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__10543);

try{var map__10544 = opts;
...
var markup_db = cljs.core.get.call(null,map__10544__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__10542);
}});
...
var temp__5802__auto___10549 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5802__auto___10549)){
var managed_print_level_10550 = temp__5802__auto___10549;
var _STAR_print_level_STAR__orig_val__10547_10551 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__10548_10552 = managed_print_level_10550;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__10548_10552);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__10546_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__10546_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__10547_10551);
}} else {
job_fn.call(null);
}
