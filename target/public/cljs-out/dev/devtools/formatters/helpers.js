...
var G__10473 = devtools.prefs.pref.call(null,v);
v = G__10473;
continue;
} else {
return v;
...
}catch (e10476){var _e__9280__auto__ = e10476;
return false;
}})();
...
}catch (e10480){var _e__9280__auto__ = e10480;
return false;
}})();
...
}catch (e10482){var _e__9280__auto__ = e10482;
return false;
}}
}
});
...
var vec__10484 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__10484,(0),null);
var name = cljs.core.nth.call(null,vec__10484,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10487_SHARP_);
}),template);
});
