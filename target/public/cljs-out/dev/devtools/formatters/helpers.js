...
var G__13183 = devtools.prefs.pref.call(null,v);
v = G__13183;
continue;
} else {
return v;
...
}catch (e13186){var _e__11990__auto__ = e13186;
return false;
}})();
...
}catch (e13190){var _e__11990__auto__ = e13190;
return false;
}})();
...
}catch (e13192){var _e__11990__auto__ = e13192;
return false;
}}
}
});
...
var vec__13194 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__13194,(0),null);
var name = cljs.core.nth.call(null,vec__13194,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13197_SHARP_);
}),template);
});
