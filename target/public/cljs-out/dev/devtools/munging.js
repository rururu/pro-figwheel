...
var temp__5802__auto____$1 = (o11610["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o11611 = temp__5802__auto____$1;
return (o11611["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__10533__auto__ = f;
return (o__10533__auto__["toString"]).call(o__10533__auto__);
} else {
return "";
}
}catch (e11612){var _ = e11612;
return "";
}});
...
try{var o__10533__auto___11614 = t;
(o__10533__auto___11614["cljs$lang$ctorPrWriter"]).call(o__10533__auto___11614,t,writer);
}catch (e11613){var __11615 = e11613;
}
...
var char_code = (function (){var o__10533__auto__ = (new String(char$));
return (o__10533__auto__["charCodeAt"]).call(o__10533__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__10533__auto__ = String;
return (o__10533__auto__["fromCharCode"]).call(o__10533__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__11616 = num_code;
switch (G__11616) {
case (1):
return (185);
...
var o__10533__auto__ = String;
return (o__10533__auto__["fromCharCode"]).call(o__10533__auto__,superscript_code);
});
/**
...
}catch (e11618){var _e__10540__auto__ = e11618;
return false;
}})())){
...
var vec__11619 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__11619,(0),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var o11622 = temp__5802__auto__;
var temp__5802__auto____$1 = (o11622["dependencies_"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o11623 = temp__5802__auto____$1;
return (o11623["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__11626){
var vec__11627 = p__11626;
var ns_detector = cljs.core.nth.call(null,vec__11627,(0),null);
...
var G__11633 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__11634 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__11633;
remaining_tokens = G__11634;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq11624){
...
var vec__11638 = cljs.core.split_with.call(null,(function (p1__11637_SHARP_){
return cljs.core.not_EQ_.call(null,p1__11637_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__11638,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__11638,(1),null);
...
var vec__11644 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__11644,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__11644,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__11647 = cljs.core.rest.call(null,remaining_tokens);
var G__11648 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__11647;
name_tokens = G__11648;
continue;
} else {
...
var vec__11651 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__11651,(0),null);
var arity = cljs.core.nth.call(null,vec__11651,(1),null);
var vec__11654 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__11654,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__11654,(1),null);
var vec__11657 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__11657,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__11657,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__11657,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__11657,(3),null);
...
var vec__11663 = result;
var munged_ns = cljs.core.nth.call(null,vec__11663,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__11663,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__11663,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__11663,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__11663,(4),null);
var arity = cljs.core.nth.call(null,vec__11663,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__11667 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__11667,(0),null);
var args = cljs.core.nth.call(null,vec__11667,(1),null);
var vec__11670 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__11670,(0),null);
var name = cljs.core.nth.call(null,vec__11670,(1),null);
...
var G__11673 = (arity + (1));
var G__11674 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__11675){
var vec__11676 = p__11675;
var arity = cljs.core.nth.call(null,vec__11676,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__11676,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__11679_SHARP_){
return cljs.core.get.call(null,arities,p1__11679_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__11680_SHARP_){
return cljs.core.drop.call(null,(2),p1__11680_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__11683){
var vec__11684 = p__11683;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__11684,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq11681){
var G__11682 = cljs.core.first.call(null,seq11681);
var seq11681__$1 = cljs.core.next.call(null,seq11681);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11682,seq11681__$1);
}));
...
var G__11690 = arg;
var G__11690__$1 = (((G__11690 instanceof cljs.core.Keyword))?G__11690.fqn:null);
switch (G__11690__$1) {
...
var map__11692 = options;
var map__11692__$1 = (((((!((map__11692 == null))))?(((((map__11692.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11692.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11692):map__11692);
var include_ns_QMARK_ = cljs.core.get.call(null,map__11692__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__11692__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__11692__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__11692__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__11693 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__11693,(0),null);
var fn_name = cljs.core.nth.call(null,vec__11693,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__11693,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__11693,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__11693,(4),null);
var arity = cljs.core.nth.call(null,vec__11693,(5),null);
...
var o__10533__auto__ = f;
return (o__10533__auto__["getBasis"]).call(o__10533__auto__);
});
/**
...
}catch (e11697){var _e__10540__auto__ = e11697;
...
var G__11698 = (obj[cljs.core.first.call(null,path)]);
var G__11699 = cljs.core.rest.call(null,path);
obj = G__11698;
path = G__11699;
continue;
} else {
...
var _STAR_ = (function (accum,p__11700){
var vec__11701 = p__11700;
var bit = cljs.core.nth.call(null,vec__11701,(0),null);
var protocol = cljs.core.nth.call(null,vec__11701,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__11704){
var vec__11705 = p__11704;
var ns = cljs.core.nth.call(null,vec__11705,(0),null);
var name = cljs.core.nth.call(null,vec__11705,(1),null);
var selector = cljs.core.nth.call(null,vec__11705,(2),null);
...
var post_process = (function (p__11709){
var vec__11710 = p__11709;
var munged_name = cljs.core.nth.call(null,vec__11710,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__11710,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__11708_SHARP_){
return (obj[cljs.core.first.call(null,p1__11708_SHARP_)]);
}),sorted_matches);
